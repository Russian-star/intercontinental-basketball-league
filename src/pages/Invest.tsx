...
const Invest = () => {
  ...
  const investmentOptions = [
    ...
    { amount: 25000, title: 'Платиновый', description: 'Стратегическое партнерство', benefits: ['25 лотерейных билетов', 'Максимальные привилегии', 'Индивидуальные условия', 'Персональный консультант'] }
  ];
